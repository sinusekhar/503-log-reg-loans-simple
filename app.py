...
githublink = 'https://github.com/sinusekhar/503-log-reg-loans-simple'
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                html.Div('Total Income (in dollars)'),
                dcc.Input(id='TotalIncome', value=5000, type='number', min=0, max=100000, step=500),
...
@app.callback(
    ...
    [Input(component_id='Credit_History', component_property='value'),
     ...
     Input(component_id='TotalIncome', component_property='value'),
     Input(component_id='Threshold', component_property='value')
    ])
def prediction_function(Credit_History, LoanAmount, Loan_Amount_Term, TotalIncome, Threshold):
    try:
        data = [[Credit_History, LoanAmount, Loan_Amount_Term, TotalIncome]]
